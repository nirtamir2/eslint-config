...
git clone --depth 1 --single-branch --branch main https://github.com/nirtamir2/eslint-config-inspector.git
...
This is a ESLint config inspector generated by [@nirtamir2/eslint-config](https://github.com/nirtamir2/eslint-config)
EOF
...
git push git@github.com:nirtamir2/eslint-config-inspector.git main -f
